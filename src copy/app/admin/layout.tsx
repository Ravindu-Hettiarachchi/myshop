...
import { LayoutDashboard, Store, Users, CreditCard, LogOut, Paintbrush } from 'lucide-react';
...
const NAV = [
    ...
    { href: '/admin/themes', label: 'Theme Management', icon: <Paintbrush className="w-5 h-5" /> },
];
