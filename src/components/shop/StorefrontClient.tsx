...
export default function StorefrontClient({ routePath, shopConfig, productList, sessionUserInit }: Props) {
    ...
    // Render Logic for standard templates
    const renderTemplate = () => {
        const enrichedConfig = { ...shopConfig, route_path: routePath };
        switch (shopConfig.template) {
            case 'modern-dark':
                return <ModernDark shop={enrichedConfig} products={productList as any} onAddToCart={addToCart} onOpenCart={() => setIsCartOpen(true)} cartCount={cartCount} sessionUser={sessionUser} />;
            case 'vibrant-market':
                return <VibrantMarket shop={enrichedConfig} products={productList as any} onAddToCart={addToCart} onOpenCart={() => setIsCartOpen(true)} cartCount={cartCount} sessionUser={sessionUser} />;
            case 'elegant-boutique':
                return <ElegantBoutique shop={enrichedConfig} products={productList as any} onAddToCart={addToCart} onOpenCart={() => setIsCartOpen(true)} cartCount={cartCount} sessionUser={sessionUser} />;
            default:
                return <MinimalWhite shop={enrichedConfig} products={productList as any} onAddToCart={addToCart} onOpenCart={() => setIsCartOpen(true)} cartCount={cartCount} sessionUser={sessionUser} />;
        }
    };

    const isDarkTheme = shopConfig.template === 'modern-dark';
