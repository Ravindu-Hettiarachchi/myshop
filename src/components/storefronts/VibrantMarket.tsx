                    ...
                    <div className="h-16 flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                style2={{ boxShadow: `0 4px 14px ${primaryColor}40` }}
                            >
                ...
                <section id="products" className="max-w-7xl mx-auto px-5 lg:px-10 py-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {featured.map((product) => (
                            <div key={product.id} className="group bg-white border-2 border-gray-100 rounded-3xl overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300" style={{ ':hover': { borderColor: `${primaryColor}40` } }}>
